...
# resize image height within a safe range
...
def close_transaction(
    ...
    """
    Save Response/.txt and Output/.txt files into the transaction folders.
    Returns dict with response_file and output_file paths.
    """
    base = Path(base_path)
